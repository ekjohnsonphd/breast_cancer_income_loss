...
setnames(
  df, c(
    "charlson.index", "aids.hiv", "any.malignancy", "cerebrovascular.disease", "chronic.pulmonary.disease",
  ...
  c(
    "cci", "dx_hiv", "dx_malig", "dx_cvasc", "dx_copd", "dx_demen", "dx_diabc", "dx_diabuc", "dx_hfail", "dx_hemi",
